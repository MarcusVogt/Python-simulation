...
record B0470_U_Restroom "B0470_U_Restroom"
  extends AixLib.DataBase.ThermalZones.ZoneBaseRecord(
    ...
    nOrientations = 6,
    AWin = {21.683553899885496, 0.9163919602985148, 21.683553899885496, 0.9163919602985148, 0.0, 0},
    ATransparent = {21.683553899885496, 0.9163919602985148, 21.683553899885496, 0.9163919602985148, 0.0, 0},
    alphaWin = 2.7,
    RWin = 0.00361207294771,
    gWin = 0.7800000000000001,
    UWin= 3.001782134105591,
    ratioWinConRad = 0.03,
    AExt = {50.624458722334595, 2.1394946225976557, 50.624458722334595, 2.1394946225976557, 159.9542889, 159.9542889},
    alphaExt = 1.9480462079231446,
    nExt = 1,
    RExt = {0.000158035670597},
    RExtRem = 0.000660025035144,
    CExt = {101375001.75},
    AInt = 959.7257334000001,
    alphaInt = 2.410144927536232,
    nInt = 1,
    RInt = {6.71207757332e-05},
    CInt = {120011025.872},
    AFloor = 0,
