...
model B0250_U
  "This is the simulation model of B0250_U"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 11864.935166201001,
    ABuilding=3827.3984407099997,
    ASurTot=26664.44273932638,
    numZones = 7,
    zoneParam = {
	   B0250_U_DataBase.B0250_U_Office(),
	   B0250_U_DataBase.B0250_U_ICT(),
	   B0250_U_DataBase.B0250_U_Laboratory(),
	   B0250_U_DataBase.B0250_U_Sanitary(),
	   B0250_U_DataBase.B0250_U_Meeting(),
	   B0250_U_DataBase.B0250_U_Storage(),
	   B0250_U_DataBase.B0250_U_Floor()
      },
	heatAHU=true,
    coolAHU=true,
    dehuAHU=true,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/B0250_U//InternalGains_B0250_U.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/B0250_U//AHU_B0250_U.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/B0250_U//Tset_B0250_U.mat"),
    columns=2:8)
