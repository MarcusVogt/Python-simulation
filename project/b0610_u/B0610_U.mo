within Project.B0610_U;
model B0610_U
  "This is the simulation model of B0610_U"
  ...
  AixLib.ThermalZones.ReducedOrder.Multizone.MultizoneEquipped multizone(
    ...
    T_start = 293.15,
    VAir = 9627.66471,
    ABuilding=3414.0655000000006,
    ASurTot=21958.060676424582,
    numZones = 7,
    zoneParam = {
	   B0610_U_DataBase.B0610_U_Office(),
	   B0610_U_DataBase.B0610_U_ICT(),
	   B0610_U_DataBase.B0610_U_Laboratory(),
	   B0610_U_DataBase.B0610_U_Sanitary(),
	   B0610_U_DataBase.B0610_U_Meeting(),
	   B0610_U_DataBase.B0610_U_Storage(),
	   B0610_U_DataBase.B0610_U_Floor()
      },
	heatAHU=true,
    coolAHU=true,
    dehuAHU=true,
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/B0610_U//InternalGains_B0610_U.mat"),
    columns=2:22)
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/B0610_U//AHU_B0610_U.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Project/B0610_U//Tset_B0610_U.mat"),
    columns=2:8)
